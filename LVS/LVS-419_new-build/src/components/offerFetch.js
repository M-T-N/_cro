  ...
  qsa('.glide__slide-content__cta').forEach(async function(el, index){
    ...
    .then(function (template) {
      ...
      //const tagline = html.querySelector('.offer-details__hero-inner h1').innerText;
			const tagline = html.querySelector('.offers-intro__contents h1').innerText;
      //const stayDates = html.querySelector('.offer-details__dates h4').innerText;
			const stayDates = html.querySelector('.offers-intro__header--dates h4').innerText;
      ...
      // });
			...
			const offerDetails = html.querySelector('.offers-intro__contents-body p').innerText;
